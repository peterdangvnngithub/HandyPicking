...
import 
    {
        getAll_HandyPicking_MS, 
        check_Exists_HandyPicking_MS, 
        createNew_Handy_Picking_MS 
    } from '../controller/handyPickingMS.controller.js';

const router = Router();

// GET
router.get('/handyPickingMS',           getAll_HandyPicking_MS);
router.get('/handyPickingMS/:plNo',     check_Exists_HandyPicking_MS);
