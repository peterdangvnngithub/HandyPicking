...
public class PickingDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL_HANDY_MS_COLUMN6 = "column6";
    ...
    public long addHandyMS(handy_ms handy_ms)
    {
        ...
        cv.put(COL_HANDY_MS_COLUMN6,            handy_ms.getCOLUMN6());
    ...
    public long addHandyDetail(handy_detail handyDetail) {
        try {
            ...
            cv.put(COL_HANDY_DETAIL_CUSTOMER_ITEM_CODE, handyDetail.getCUSTOMER_ITEM_CODE());
    ...
    public long deleteHandyDetailByCode(handy_detail handyDetail)
    {
        ...
        String[] whereArgs = new String[] { handyDetail.getPICKING_LIST_NO(), handyDetail.getCUSTOMER_ITEM_CODE(), handyDetail.getSERIES() };
