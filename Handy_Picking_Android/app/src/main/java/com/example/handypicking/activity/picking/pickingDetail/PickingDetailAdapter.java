...
public class PickingDetailAdapter extends RecyclerView.Adapter<PickingDetailAdapter.PickingHolder> {
    ...
    public PickingDetailAdapter(Context mContext, List<handy_detail> list_handyDetail, ItemClickListener itemClickListener) {
    ...
    public class PickingHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        {
            txtItemCode.setText(handyDetail.getCUSTOMER_ITEM_CODE());
            txtSeries.setText(handyDetail.getSERIES());
            DecimalFormat formatter = new DecimalFormat("###,###,###");
            txtQuantity.setText(formatter.format(handyDetail.getQUANTITY()));
        }
